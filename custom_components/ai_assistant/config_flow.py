"""Adds config flow for AI Assistant."""
...
class AIAssistantConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(
        ...
        return AIAssistantOptionsFlow(config_entry)


class AIAssistantOptionsFlow(config_entries.OptionsFlow):
    """AI Assistant config flow options handler."""
    ...
    async def async_step_general_config(
        ...
        schema = ai_assistant_schema_general_config(self.config_entry.options)
        return self.async_show_form(
    ...
    async def async_step_prompt_system(
        ...
        schema = ai_assistant_schema_prompt_system(self.config_entry.options)
        return self.async_show_form(
...
def ai_assistant_schema_general_config(options: MappingProxyType[str, Any]) -> dict:
...
def ai_assistant_schema_prompt_system(options: MappingProxyType[str, Any]) -> dict:
...
def ai_assistant_schema_model_config(options: MappingProxyType[str, Any], MODELS: list[str]) -> dict:
